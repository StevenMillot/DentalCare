...
(function(){"use strict";const h=e=>document.querySelector(e),L=e=>document.querySelectorAll(e);function H(e,r){let t;return function(...n){clearTimeout(t),t=setTimeout(()=>e(...n),r)}}function N(e){window.requestIdleCallback?requestIdleCallback(e,{timeout:100}):setTimeout(e,1)}function E(e){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}let O=()=>{};const w=(()=>{const r={success:6500,info:5500,error:1e4,warning:8e3},t=[];function s(i){return i==="success"?"i-check-circle":i==="error"?"i-alert-circle":i==="warning"?"i-alert-triangle":"i-info"}function n(){for(;t.length>=4;){const i=t.shift();i.timer&&clearTimeout(i.timer),i.el&&i.el.parentNode&&i.el.remove()}}function v(i){const m=t.findIndex(d=>d.el===i);m>=0&&(t[m].timer&&clearTimeout(t[m].timer),t.splice(m,1)),!(!i||!i.parentNode)&&(i.classList.add("toast--leaving"),window.setTimeout(()=>{i.parentNode&&i.remove()},280))}function b(i,m="info"){if(!i||typeof i!="string")return;n();const d=document.createElement("div");d.className=`toast toast--${m}`,d.setAttribute("role",m==="error"?"alert":"status"),d.setAttribute("aria-live",m==="error"?"assertive":"polite");const l=document.createElement("div");l.className="toast__row";const a=document.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("class","toast__icon icon"),a.setAttribute("aria-hidden","true");const f=document.createElementNS("http://www.w3.org/2000/svg","use");f.setAttribute("href",`#${s(m)}`),a.appendChild(f);const u=document.createElement("p");u.className="toast__text",u.textContent=i;const C=document.createElement("button");C.type="button",C.className="toast__close",C.setAttribute("aria-label","Fermer la notification");const x=document.createElementNS("http://www.w3.org/2000/svg","svg");x.setAttribute("class","icon"),x.setAttribute("aria-hidden","true");const A=document.createElementNS("http://www.w3.org/2000/svg","use");A.setAttribute("href","#i-x"),x.appendChild(A),C.appendChild(x),l.appendChild(a),l.appendChild(u),d.appendChild(l),d.appendChild(C),(document.getElementById("toast-host")||document.body).appendChild(d);const M={el:d,timer:null};t.push(M),window.requestAnimationFrame(()=>d.classList.add("toast--visible"));const S=r[m]||r.info;M.timer=window.setTimeout(()=>v(d),S),C.addEventListener("click",()=>{M.timer&&clearTimeout(M.timer),M.timer=null,v(d)})}return{success:i=>b(i,"success"),error:i=>b(i,"error"),info:i=>b(i,"info"),warning:i=>b(i,"warning")}})();function X(){const e=h(".navbar"),r=h(".navbar__toggle"),t=h(".navbar__menu--mobile");if(r&&t){let n=function(){s&&(document.removeEventListener("keydown",i),document.removeEventListener("click",m,!0),s=!1)},v=function(l){r.setAttribute("aria-expanded",l?"true":"false"),r.setAttribute("aria-label",l?"Fermer le menu":"Ouvrir le menu")},b=function(){v(!1),t.classList.remove("navbar__menu--active"),n()},i=function(l){l.key==="Escape"&&t.classList.contains("navbar__menu--active")&&(l.preventDefault(),b(),r.focus())},m=function(l){t.classList.contains("navbar__menu--active")&&(t.contains(l.target)||r.contains(l.target)||b())},d=function(){s||(s=!0,window.setTimeout(()=>{document.addEventListener("keydown",i),document.addEventListener("click",m,!0)},0))},s=!1;O=n,r.addEventListener("click",()=>{const a=!(r.getAttribute("aria-expanded")==="true");if(v(a),t.classList.toggle("navbar__menu--active",a),a){const f=t.querySelector(".navbar__link");f&&f.focus(),d()}else n(),r.focus()}),t.querySelectorAll("a[href]").forEach(l=>{l.addEventListener("click",()=>{t.classList.contains("navbar__menu--active")&&b()})})}if(e){const s=H(()=>{window.scrollY>100?e.classList.add("navbar--scrolled"):e.classList.remove("navbar--scrolled")},10);window.addEventListener("scroll",s,{passive:!0})}}function G(){L('a[href^="#"]').forEach(e=>{e.addEventListener("click",function(r){r.preventDefault();const t=h(this.getAttribute("href"));if(t){const s=t.offsetTop-70;window.scrollTo({top:s,behavior:"smooth"})}})})}function K(){const e=h("#appointmentForm");if(!e)return;const r=h("#appointmentForm-banner"),t=L("#appointmentForm .form__input, #appointmentForm .form__select, #appointmentForm .form__textarea"),s=e.querySelector('button[type="submit"]'),n=new Set(["given-name","family-name","email","phone","service"]);function v(o){o.classList.remove("form__input--error","form__select--error","form__textarea--error")}function b(o){v(o),o.matches("select")?o.classList.add("form__select--error"):o.matches("textarea")?o.classList.add("form__textarea--error"):o.classList.add("form__input--error")}function i(o,c){if(!o||!o.id||!n.has(o.id))return;const p=document.getElementById(`err-${o.id}`);c?(b(o),o.setAttribute("aria-invalid","true"),p&&(p.textContent=c,p.hidden=!1)):(v(o),o.removeAttribute("aria-invalid"),p&&(p.textContent="",p.hidden=!0))}function m(o){const c=o.trim();return c?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(c)?"":"Format d\u2019adresse e-mail invalide.":"Indiquez votre adresse e-mail."}function d(o){const c=String(o).replace(/\D/g,"");return String(o).trim()?c.length<10?"Saisissez au moins 10 chiffres (avec ou sans espaces).":"":"Indiquez un num\xE9ro de t\xE9l\xE9phone."}function l(o){switch(o.id){case"given-name":return o.value.trim()?"":"Indiquez votre pr\xE9nom.";case"family-name":return o.value.trim()?"":"Indiquez votre nom.";case"email":return m(o.value);case"phone":return d(o.value);case"service":return o.value?"":"Choisissez un motif de consultation.";default:return""}}function a(){r&&(r.hidden=!0,r.textContent="")}function f(o){!r||o<1||(r.hidden=!1,r.textContent=o===1?"Veuillez corriger le champ indiqu\xE9 ci-dessous.":`Veuillez corriger les ${o} champs indiqu\xE9s ci-dessous.`)}function u(){n.forEach(o=>{const c=document.getElementById(o);c&&i(c,"")}),a()}function C(){const o=["given-name","family-name","email","phone","service"].map(g=>document.getElementById(g)).filter(Boolean);let c=null,p=0;return o.forEach(g=>{const y=l(g);y?(i(g,y),p+=1,c||(c=g)):i(g,"")}),a(),p>0&&f(p),{ok:p===0,firstInvalid:c}}function x(o){const c=o.target;!c.id||!n.has(c.id)||i(c,l(c))}function A(o){const c=o.target;if(!c.id||!n.has(c.id))return;const p=l(c);i(c,p)}t.forEach(o=>{o.addEventListener("blur",x),o.addEventListener("input",A)}),e.addEventListener("submit",d1),u();const Z=1800,M="https://api.web3forms.com/submit";async function S(o,c){const p=`https://formsubmit.co/ajax/${encodeURIComponent(o)}`,g=await fetch(p,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(c)}),y=await g.text();if(!g.ok)throw new Error(y||g.statusText||"Envoi refus\xE9");return y}async function d1(o){o.preventDefault();const{ok:c,firstInvalid:p}=C();if(!c){p&&(p.focus(),p.scrollIntoView({block:"nearest",behavior:"smooth"})),w.error("Veuillez compl\xE9ter ou corriger les champs indiqu\xE9s dans le formulaire.");return}const g=e.querySelector(".form__hp");if(g&&g.checked){w.error("Impossible d\u2019envoyer le message. R\xE9essayez ou contactez-nous par t\xE9l\xE9phone.");return}const y=h("#given-name").value.trim(),I=h("#family-name").value.trim(),_=h("#email").value.trim(),q=h("#phone").value.trim(),B=h("#service"),m1=B.value,j=B.options[B.selectedIndex],V=j?j.text:m1,P=h("#message").value.trim(),T=`[paro-spe.fr] Demande RDV \u2014 ${V}`,F=["Bonjour,","",`Pr\xE9nom : ${y}`,`Nom : ${I}`,`Email : ${_}`,`T\xE9l\xE9phone : ${q}`,`Motif : ${V}`];P&&F.push("","Message :",P),F.push("","\u2014 Message envoy\xE9 depuis paro-spe.fr");const $=F.join(`
`),D=(e.getAttribute("data-web3forms-access-key")||"").trim(),U=e.getAttribute("data-contact-email")||"secretariat@paro-spe.fr",f1=s.textContent;s.disabled=!0,s.textContent="Envoi en cours\u2026";const W=()=>{w.success("Votre message a bien \xE9t\xE9 envoy\xE9. Nous vous r\xE9pondrons dans les meilleurs d\xE9lais."),e.reset(),u(),typeof gtag<"u"&&gtag("event","form_submit",{event_category:"engagement",event_label:"appointment_form"})},p1=()=>{const z=`mailto:${U}?subject=${encodeURIComponent(T)}&body=${encodeURIComponent($)}`;if(z.length>Z){w.warning("Message trop long pour un lien courriel. Raccourcissez ou \xE9crivez \xE0 secretariat@paro-spe.fr.");return}w.info("Ouverture de votre messagerie avec le message pr\xE9rempli\u2026 Si rien ne s\u2019affiche, \xE9crivez \xE0 secretariat@paro-spe.fr."),e.reset(),u(),window.setTimeout(()=>{window.location.href=z},450)};try{if(D){const z=await fetch(M,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify({access_key:D,subject:T,name:`${y} ${I}`.trim(),email:_,phone:q,message:$,from_name:`${y} ${I}`.trim(),replyto:_,botcheck:!1})});let k;try{k=await z.json()}catch{w.error("R\xE9ponse du service d\u2019envoi invalide. R\xE9essayez dans quelques minutes.");return}if(k&&k.success)W();else{const Y=k&&(k.message||k.body&&k.body.message)||"L\u2019envoi a \xE9chou\xE9. R\xE9essayez plus tard ou contactez-nous par t\xE9l\xE9phone.";w.error(Y)}}else await S(U,{_subject:T,_replyto:_,_captcha:"false",name:`${y} ${I}`.trim(),email:_,phone:q,motif:V,message:$}),W()}catch{D?w.error("Connexion impossible. V\xE9rifiez votre r\xE9seau puis r\xE9essayez."):(w.warning("Envoi automatique indisponible. Nous ouvrons votre messagerie avec le message pr\xE9rempli."),p1())}finally{s.textContent=f1,s.disabled=!1}}}function J(){if(!("IntersectionObserver"in window)){L(".traitement-card, .team-member, .contact__item, .cabinet-media-carousel").forEach(s=>{s.classList.add("reveal","is-visible")});return}const e=new IntersectionObserver(t=>{t.forEach(s=>{if(!s.isIntersecting)return;const n=s.target;n.classList.add("is-visible"),e.unobserve(n)})},{threshold:.1,rootMargin:"0px 0px -50px 0px"});L(".traitement-card, .team-member, .contact__item, .cabinet-media-carousel").forEach(t=>{t.classList.add("reveal"),e.observe(t)})}function Q(){const e=h(".navbar__toggle"),r=h(".navbar__menu--mobile"),t=H(()=>{window.innerWidth>768&&e&&r&&(e.setAttribute("aria-expanded","false"),e.setAttribute("aria-label","Ouvrir le menu"),r.classList.remove("navbar__menu--active"),O())},250);window.addEventListener("resize",t,{passive:!0})}function e1(){L('a[target="_blank"]').forEach(e=>{const r=e.getAttribute("rel")||"";/\bnoopener\b/i.test(r)||e.setAttribute("rel",r?`${r} noopener noreferrer`.trim():"noopener noreferrer")})}function t1(){const e=L("img[data-src]");if(e.length===0)return;if(!("IntersectionObserver"in window)){e.forEach(t=>{t.dataset.src&&(t.src=t.dataset.src)});return}const r=new IntersectionObserver(t=>{t.forEach(s=>{if(s.isIntersecting){const n=s.target;n.dataset.src&&(n.src=n.dataset.src,n.removeAttribute("data-src")),n.classList.remove("lazy"),r.unobserve(n)}})},{rootMargin:"50px",threshold:.01});e.forEach(t=>r.observe(t))}function r1(){function e(r,t,s){typeof gtag<"u"&&gtag("event",t,{event_category:r,event_label:s})}L(".btn--primary").forEach(r=>{r.addEventListener("click",()=>{e("engagement","cta_click",r.textContent.trim())})})}function o1(){const e=new Date().getFullYear();L(".copyright-year").forEach(t=>{t.textContent=e})}function n1(){o1(),(function(){const t="assets/Icones/icons.svg",s="http://www.w3.org/1999/xlink",n="svg-sprite-runtime",v=`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
