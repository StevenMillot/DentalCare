(function(){"use strict";const v=e=>document.querySelector(e),w=e=>document.querySelectorAll(e);function $(e,o){let t;return function(...r){clearTimeout(t),t=setTimeout(()=>e(...r),o)}}function H(e){window.requestIdleCallback?requestIdleCallback(e,{timeout:100}):setTimeout(e,1)}let N=()=>{};const L=(()=>{const o={success:6500,info:5500,error:1e4,warning:8e3},t=[];function s(i){return i==="success"?"i-check-circle":i==="error"?"i-alert-circle":i==="warning"?"i-alert-triangle":"i-info"}function r(){for(;t.length>=4;){const i=t.shift();i.timer&&clearTimeout(i.timer),i.el&&i.el.parentNode&&i.el.remove()}}function C(i){const m=t.findIndex(u=>u.el===i);m>=0&&(t[m].timer&&clearTimeout(t[m].timer),t.splice(m,1)),!(!i||!i.parentNode)&&(i.classList.add("toast--leaving"),window.setTimeout(()=>{i.parentNode&&i.remove()},280))}function b(i,m="info"){if(!i||typeof i!="string")return;r();const u=document.createElement("div");u.className=`toast toast--${m}`,u.setAttribute("role",m==="error"?"alert":"status"),u.setAttribute("aria-live",m==="error"?"assertive":"polite");const d=document.createElement("div");d.className="toast__row";const a=document.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("class","toast__icon icon"),a.setAttribute("aria-hidden","true");const f=document.createElementNS("http://www.w3.org/2000/svg","use");f.setAttribute("href",`#${s(m)}`),a.appendChild(f);const l=document.createElement("p");l.className="toast__text",l.textContent=i;const h=document.createElement("button");h.type="button",h.className="toast__close",h.setAttribute("aria-label","Fermer la notification");const x=document.createElementNS("http://www.w3.org/2000/svg","svg");x.setAttribute("class","icon"),x.setAttribute("aria-hidden","true");const z=document.createElementNS("http://www.w3.org/2000/svg","use");z.setAttribute("href","#i-x"),x.appendChild(z),h.appendChild(x),d.appendChild(a),d.appendChild(l),u.appendChild(d),u.appendChild(h),(document.getElementById("toast-host")||document.body).appendChild(u);const M={el:u,timer:null};t.push(M),window.requestAnimationFrame(()=>u.classList.add("toast--visible"));const S=o[m]||o.info;M.timer=window.setTimeout(()=>C(u),S),h.addEventListener("click",()=>{M.timer&&clearTimeout(M.timer),M.timer=null,C(u)})}return{success:i=>b(i,"success"),error:i=>b(i,"error"),info:i=>b(i,"info"),warning:i=>b(i,"warning")}})();function J(){const e=v(".navbar"),o=v(".navbar__toggle"),t=v(".navbar__menu--mobile"),s=w(".navbar__link");if(o&&t){let C=function(){r&&(document.removeEventListener("keydown",i),document.removeEventListener("click",m,!0),r=!1)},b=function(){o.setAttribute("aria-expanded","false"),t.classList.remove("navbar__menu--active"),C()},i=function(d){d.key==="Escape"&&t.classList.contains("navbar__menu--active")&&(d.preventDefault(),b(),o.focus())},m=function(d){t.classList.contains("navbar__menu--active")&&(t.contains(d.target)||o.contains(d.target)||b())},u=function(){r||(r=!0,window.setTimeout(()=>{document.addEventListener("keydown",i),document.addEventListener("click",m,!0)},0))},r=!1;N=C,o.addEventListener("click",()=>{const a=!(o.getAttribute("aria-expanded")==="true");if(o.setAttribute("aria-expanded",a),t.classList.toggle("navbar__menu--active",a),a){const f=t.querySelector(".navbar__link");f&&f.focus(),u()}else C(),o.focus()}),s.forEach(d=>{d.addEventListener("click",()=>{t.classList.contains("navbar__menu--active")&&b()})})}if(e){const r=$(()=>{window.scrollY>100?e.classList.add("navbar--scrolled"):e.classList.remove("navbar--scrolled")},10);window.addEventListener("scroll",r,{passive:!0})}}function Q(){w('a[href^="#"]').forEach(e=>{e.addEventListener("click",function(o){o.preventDefault();const t=v(this.getAttribute("href"));if(t){const s=t.offsetTop-70;window.scrollTo({top:s,behavior:"smooth"})}})})}function e1(){const e=v("#appointmentForm");if(!e)return;const o=v("#appointmentForm-banner"),t=w("#appointmentForm .form__input, #appointmentForm .form__select, #appointmentForm .form__textarea"),s=e.querySelector('button[type="submit"]'),r=new Set(["given-name","family-name","email","phone","service"]);function C(n){n.classList.remove("form__input--error","form__select--error","form__textarea--error")}function b(n){C(n),n.matches("select")?n.classList.add("form__select--error"):n.matches("textarea")?n.classList.add("form__textarea--error"):n.classList.add("form__input--error")}function i(n,c){if(!n||!n.id||!r.has(n.id))return;const p=document.getElementById(`err-${n.id}`);c?(b(n),n.setAttribute("aria-invalid","true"),p&&(p.textContent=c,p.hidden=!1)):(C(n),n.removeAttribute("aria-invalid"),p&&(p.textContent="",p.hidden=!0))}function m(n){const c=n.trim();return c?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(c)?"":"Format d\u2019adresse e-mail invalide.":"Indiquez votre adresse e-mail."}function u(n){const c=String(n).replace(/\D/g,"");return String(n).trim()?c.length<10?"Saisissez au moins 10 chiffres (avec ou sans espaces).":"":"Indiquez un num\xE9ro de t\xE9l\xE9phone."}function d(n){switch(n.id){case"given-name":return n.value.trim()?"":"Indiquez votre pr\xE9nom.";case"family-name":return n.value.trim()?"":"Indiquez votre nom.";case"email":return m(n.value);case"phone":return u(n.value);case"service":return n.value?"":"Choisissez un motif de consultation.";default:return""}}function a(){o&&(o.hidden=!0,o.textContent="")}function f(n){!o||n<1||(o.hidden=!1,o.textContent=n===1?"Veuillez corriger le champ indiqu\xE9 ci-dessous.":`Veuillez corriger les ${n} champs indiqu\xE9s ci-dessous.`)}function l(){r.forEach(n=>{const c=document.getElementById(n);c&&i(c,"")}),a()}function h(){const n=["given-name","family-name","email","phone","service"].map(g=>document.getElementById(g)).filter(Boolean);let c=null,p=0;return n.forEach(g=>{const y=d(g);y?(i(g,y),p+=1,c||(c=g)):i(g,"")}),a(),p>0&&f(p),{ok:p===0,firstInvalid:c}}function x(n){const c=n.target;!c.id||!r.has(c.id)||i(c,d(c))}function z(n){const c=n.target;if(!c.id||!r.has(c.id))return;const p=d(c);i(c,p)}t.forEach(n=>{n.addEventListener("blur",x),n.addEventListener("input",z)}),e.addEventListener("submit",d1),l();const U=1800,M="https://api.web3forms.com/submit";async function S(n,c){const p=`https://formsubmit.co/ajax/${encodeURIComponent(n)}`,g=await fetch(p,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(c)}),y=await g.text();if(!g.ok)throw new Error(y||g.statusText||"Envoi refus\xE9");return y}async function d1(n){n.preventDefault();const{ok:c,firstInvalid:p}=h();if(!c){p&&(p.focus(),p.scrollIntoView({block:"nearest",behavior:"smooth"})),L.error("Veuillez compl\xE9ter ou corriger les champs indiqu\xE9s dans le formulaire.");return}const g=e.querySelector(".form__hp");if(g&&g.checked){L.error("Impossible d\u2019envoyer le message. R\xE9essayez ou contactez-nous par t\xE9l\xE9phone.");return}const y=v("#given-name").value.trim(),A=v("#family-name").value.trim(),_=v("#email").value.trim(),I=v("#phone").value.trim(),q=v("#service"),u1=q.value,W=q.options[q.selectedIndex],B=W?W.text:u1,Y=v("#message").value.trim(),V=`[parodontia.fr] Demande RDV \u2014 ${B}`,T=["Bonjour,","",`Pr\xE9nom : ${y}`,`Nom : ${A}`,`Email : ${_}`,`T\xE9l\xE9phone : ${I}`,`Motif : ${B}`];Y&&T.push("","Message :",Y),T.push("","\u2014 Message envoy\xE9 depuis parodontia.fr");const D=T.join(`
`),F=(e.getAttribute("data-web3forms-access-key")||"").trim(),X=e.getAttribute("data-contact-email")||"contact@parodontia.fr",m1=s.textContent;s.disabled=!0,s.textContent="Envoi en cours\u2026";const G=()=>{L.success("Votre message a bien \xE9t\xE9 envoy\xE9. Nous vous r\xE9pondrons dans les meilleurs d\xE9lais."),e.reset(),l(),typeof gtag<"u"&&gtag("event","form_submit",{event_category:"engagement",event_label:"appointment_form"})},f1=()=>{const E=`mailto:${X}?subject=${encodeURIComponent(V)}&body=${encodeURIComponent(D)}`;if(E.length>U){L.warning("Message trop long pour un lien courriel. Raccourcissez ou \xE9crivez \xE0 contact@parodontia.fr.");return}L.info("Ouverture de votre messagerie avec le message pr\xE9rempli\u2026 Si rien ne s\u2019affiche, \xE9crivez \xE0 contact@parodontia.fr."),e.reset(),l(),window.setTimeout(()=>{window.location.href=E},450)};try{if(F){const E=await fetch(M,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify({access_key:F,subject:V,name:`${y} ${A}`.trim(),email:_,phone:I,message:D,from_name:`${y} ${A}`.trim(),replyto:_,botcheck:!1})});let k;try{k=await E.json()}catch{L.error("R\xE9ponse du service d\u2019envoi invalide. R\xE9essayez dans quelques minutes.");return}if(k&&k.success)G();else{const K=k&&(k.message||k.body&&k.body.message)||"L\u2019envoi a \xE9chou\xE9. R\xE9essayez plus tard ou contactez-nous par t\xE9l\xE9phone.";L.error(K)}}else await S(X,{_subject:V,_replyto:_,_captcha:"false",name:`${y} ${A}`.trim(),email:_,phone:I,motif:B,message:D}),G()}catch{F?L.error("Connexion impossible. V\xE9rifiez votre r\xE9seau puis r\xE9essayez."):(L.warning("Envoi automatique indisponible. Nous ouvrons votre messagerie avec le message pr\xE9rempli."),f1())}finally{s.textContent=m1,s.disabled=!1}}}function t1(){if(!("IntersectionObserver"in window)){w(".traitement-card, .team-member, .contact__item, .cabinet-media-carousel").forEach(s=>{s.classList.add("reveal","is-visible")});return}const e=new IntersectionObserver(t=>{t.forEach(s=>{if(!s.isIntersecting)return;const r=s.target;r.classList.add("is-visible"),e.unobserve(r)})},{threshold:.1,rootMargin:"0px 0px -50px 0px"});w(".traitement-card, .team-member, .contact__item, .cabinet-media-carousel").forEach(t=>{t.classList.add("reveal"),e.observe(t)})}function o1(){const e=v(".navbar__toggle"),o=v(".navbar__menu--mobile"),t=$(()=>{window.innerWidth>768&&e&&o&&(e.setAttribute("aria-expanded","false"),o.classList.remove("navbar__menu--active"),N())},250);window.addEventListener("resize",t,{passive:!0})}function r1(){w('a[target="_blank"]').forEach(e=>{const o=e.getAttribute("rel")||"";/\bnoopener\b/i.test(o)||e.setAttribute("rel",o?`${o} noopener noreferrer`.trim():"noopener noreferrer")})}function n1(){const e=w("img[data-src]");if(e.length===0)return;if(!("IntersectionObserver"in window)){e.forEach(t=>{t.dataset.src&&(t.src=t.dataset.src)});return}const o=new IntersectionObserver(t=>{t.forEach(s=>{if(s.isIntersecting){const r=s.target;r.dataset.src&&(r.src=r.dataset.src,r.removeAttribute("data-src")),r.classList.remove("lazy"),o.unobserve(r)}})},{rootMargin:"50px",threshold:.01});e.forEach(t=>o.observe(t))}function i1(){function e(o,t,s){typeof gtag<"u"&&gtag("event",t,{event_category:o,event_label:s})}w(".btn--primary").forEach(o=>{o.addEventListener("click",()=>{e("engagement","cta_click",o.textContent.trim())})})}function s1(){const e=new Date().getFullYear();w(".copyright-year").forEach(t=>{t.textContent=e})}function a1(){s1(),(function(){const t="assets/Icones/icons.svg",s="http://www.w3.org/1999/xlink",r="svg-sprite-runtime",C=`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
</svg>`;let b=!1;function i(){return document.querySelector('svg use[href*="assets/Icones/icons.svg#"], svg use[href*="assets/icones/icons.svg#"], svg use[xlink\\:href*="assets/Icones/icons.svg#"], svg use[xlink\\:href*="assets/icones/icons.svg#"]')}function m(){document.querySelectorAll("svg use[href], svg use[xlink\\:href]").forEach(a=>{const f=a.getAttribute("href")||a.getAttribute("xlink:href");if(!f)return;const l=f.match(/(?:^|\/)assets\/[Ii]cones\/icons\.svg#(.+)$/);if(!l)return;const h=`#${l[1]}`;a.setAttribute("href",h),a.setAttributeNS(s,"xlink:href",h)})}async function u(){if(document.getElementById(r)){m();return}let a="";if(location.protocol!=="file:")try{const h=await fetch(t,{cache:"force-cache"});if(!h.ok)throw new Error(`sprite fetch failed (${h.status})`);a=await h.text()}catch{a=C}else a=C;const f=document.createElement("div");f.innerHTML=a.trim();const l=f.querySelector("svg");if(!l)throw new Error("sprite svg missing");l.id=r,l.setAttribute("aria-hidden","true"),l.setAttribute("focusable","false"),l.style.position="absolute",l.style.width="0",l.style.height="0",l.style.overflow="hidden",l.style.pointerEvents="none",l.style.left="-9999px",l.style.top="-9999px",document.body.insertAdjacentElement("afterbegin",l),m()}function d(){b||(b=!0,Promise.resolve().then(()=>u()).catch(()=>{try{document.querySelectorAll("svg use[href]").forEach(a=>{const f=a.getAttribute("href");f&&(a.getAttribute("xlink:href")||a.setAttributeNS(s,"xlink:href",f))})}catch{}}))}if(i()){if(location.protocol==="file:"){d();return}if("IntersectionObserver"in window){const a=i();if(!a)return;const f=new IntersectionObserver(l=>{l.some(h=>h.isIntersecting)&&(f.disconnect(),d())},{rootMargin:"400px 0px"});f.observe(a)}else window.requestIdleCallback?requestIdleCallback(d,{timeout:1500}):setTimeout(d,200)}})();const e=v("#hero-title");e&&e.classList.add("is-visible")}function c1(){J(),Q(),e1(),o1(),r1()}function O(){H(()=>{t1(),n1(),i1()}),H(()=>{const e=v('.sidebar__action[aria-label="Retour en haut"]');e&&e.addEventListener("click",function(o){o.preventDefault();const t=window.scrollY||window.pageYOffset,s=400,r=performance.now(),C=i=>1-Math.pow(1-i,3);function b(i){const m=i-r,u=Math.min(m/s,1),d=C(u);window.scrollTo(0,t*(1-d)),u<1&&requestAnimationFrame(b)}requestAnimationFrame(b)})})}function Z(){a1(),c1(),window.requestIdleCallback?requestIdleCallback(()=>{O()},{timeout:2e3}):setTimeout(()=>{O()},100)}function l1(){const e=v(".hero__video[data-hero-src]");if(!e)return;const o=e.getAttribute("data-hero-src");if(!o)return;try{if(window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches)return}catch{}try{if(navigator.connection&&navigator.connection.saveData)return;if(navigator.connection&&typeof navigator.connection.effectiveType=="string"){const r=navigator.connection.effectiveType;if(r==="slow-2g"||r==="2g")return}}catch{}if(e.querySelector("source"))return;const t=()=>{const r=document.createElement("source");r.src=o,r.type="video/mp4",e.appendChild(r);try{e.load()}catch{}const C=e.play();C&&typeof C.catch=="function"&&C.catch(()=>{})},s=()=>{window.requestIdleCallback?requestIdleCallback(t,{timeout:4e3}):setTimeout(t,900)};document.readyState==="complete"?s():window.addEventListener("load",s,{once:!0})}function R(){l1()}function j(){if(!("serviceWorker"in navigator))return;const e=()=>{navigator.serviceWorker.register("sw.js").catch(()=>{})};window.requestIdleCallback?requestIdleCallback(e,{timeout:8e3}):setTimeout(e,2500)}function P(){const e=document.querySelector("[data-map-consent][data-map-src]");if(!e)return;const o=e.querySelector(".map__activate");if(!o)return;const t=e.getAttribute("data-map-src");if(!t)return;const s=()=>{if(e.getAttribute("data-map-loaded")==="true")return;e.setAttribute("data-map-loaded","true");const r=document.createElement("iframe");r.src=t,r.width="100%",r.height="400",r.className="map__iframe",r.allowFullscreen=!0,r.loading="lazy",r.referrerPolicy="no-referrer-when-downgrade",r.title="Carte : 40 Avenue de la Division Leclerc, 92290 Ch\xE2tenay-Malabry",r.setAttribute("aria-label","Carte Google Maps centr\xE9e sur 40 Avenue de la Division Leclerc, 92290 Ch\xE2tenay-Malabry"),e.replaceWith(r)};o.addEventListener("click",s,{once:!0})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",R):R(),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Z):Z(),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",j):j(),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",P):P(),(function(){if(document.querySelector('link[rel="manifest"]'))return;function o(){const s=document.createElement("link");s.rel="manifest",s.href="site.webmanifest",document.head.appendChild(s)}function t(){window.requestIdleCallback?requestIdleCallback(o,{timeout:3500}):setTimeout(o,0)}document.readyState==="complete"?t():window.addEventListener("load",t,{once:!0})})()})();
