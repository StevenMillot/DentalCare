/* Généré — ne pas éditer. Source: js/script.js — npm run dev:refresh */
(function(){"use strict";const b=e=>document.querySelector(e),M=e=>document.querySelectorAll(e);function H(e,r){let t;return function(...o){clearTimeout(t),t=setTimeout(()=>e(...o),r)}}function N(e){window.requestIdleCallback?requestIdleCallback(e,{timeout:100}):setTimeout(e,1)}function z(e){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}let O=()=>{};const w=(()=>{const r={success:6500,info:5500,error:1e4,warning:8e3},t=[];function s(i){return i==="success"?"i-check-circle":i==="error"?"i-alert-circle":i==="warning"?"i-alert-triangle":"i-info"}function o(){for(;t.length>=4;){const i=t.shift();i.timer&&clearTimeout(i.timer),i.el&&i.el.parentNode&&i.el.remove()}}function C(i){const m=t.findIndex(d=>d.el===i);m>=0&&(t[m].timer&&clearTimeout(t[m].timer),t.splice(m,1)),!(!i||!i.parentNode)&&(i.classList.add("toast--leaving"),window.setTimeout(()=>{i.parentNode&&i.remove()},280))}function v(i,m="info"){if(!i||typeof i!="string")return;o();const d=document.createElement("div");d.className=`toast toast--${m}`,d.setAttribute("role",m==="error"?"alert":"status"),d.setAttribute("aria-live",m==="error"?"assertive":"polite");const l=document.createElement("div");l.className="toast__row";const a=document.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("class","toast__icon icon"),a.setAttribute("aria-hidden","true");const f=document.createElementNS("http://www.w3.org/2000/svg","use");f.setAttribute("href",`#${s(m)}`),a.appendChild(f);const u=document.createElement("p");u.className="toast__text",u.textContent=i;const h=document.createElement("button");h.type="button",h.className="toast__close",h.setAttribute("aria-label","Fermer la notification");const x=document.createElementNS("http://www.w3.org/2000/svg","svg");x.setAttribute("class","icon"),x.setAttribute("aria-hidden","true");const A=document.createElementNS("http://www.w3.org/2000/svg","use");A.setAttribute("href","#i-x"),x.appendChild(A),h.appendChild(x),l.appendChild(a),l.appendChild(u),d.appendChild(l),d.appendChild(h),(document.getElementById("toast-host")||document.body).appendChild(d);const L={el:d,timer:null};t.push(L),window.requestAnimationFrame(()=>d.classList.add("toast--visible"));const S=r[m]||r.info;L.timer=window.setTimeout(()=>C(d),S),h.addEventListener("click",()=>{L.timer&&clearTimeout(L.timer),L.timer=null,C(d)})}return{success:i=>v(i,"success"),error:i=>v(i,"error"),info:i=>v(i,"info"),warning:i=>v(i,"warning")}})();function X(){const e=b(".navbar"),r=b(".navbar__toggle"),t=b(".navbar__menu--mobile");if(r&&t){let o=function(){s&&(document.removeEventListener("keydown",i),document.removeEventListener("click",m,!0),s=!1)},C=function(l){r.setAttribute("aria-expanded",l?"true":"false"),r.setAttribute("aria-label",l?"Fermer le menu":"Ouvrir le menu")},v=function(){C(!1),t.classList.remove("navbar__menu--active"),o()},i=function(l){l.key==="Escape"&&t.classList.contains("navbar__menu--active")&&(l.preventDefault(),v(),r.focus())},m=function(l){t.classList.contains("navbar__menu--active")&&(t.contains(l.target)||r.contains(l.target)||v())},d=function(){s||(s=!0,window.setTimeout(()=>{document.addEventListener("keydown",i),document.addEventListener("click",m,!0)},0))},s=!1;O=o,r.addEventListener("click",()=>{const a=!(r.getAttribute("aria-expanded")==="true");if(C(a),t.classList.toggle("navbar__menu--active",a),a){const f=t.querySelector(".navbar__link");f&&f.focus(),d()}else o(),r.focus()}),t.querySelectorAll("a[href]").forEach(l=>{l.addEventListener("click",()=>{t.classList.contains("navbar__menu--active")&&v()})})}if(e){const s=H(()=>{window.scrollY>100?e.classList.add("navbar--scrolled"):e.classList.remove("navbar--scrolled")},10);window.addEventListener("scroll",s,{passive:!0})}}function G(){const e=window.matchMedia("(prefers-reduced-motion: reduce)").matches;M('a[href^="#"]').forEach(r=>{const t=r.getAttribute("href");!t||t==="#"||r.addEventListener("click",function(s){const o=document.getElementById(t.slice(1));o&&(s.preventDefault(),o.hasAttribute("tabindex")||o.setAttribute("tabindex","-1"),o.scrollIntoView({behavior:e?"auto":"smooth",block:"start"}),o.focus({preventScroll:!0}),history.pushState?history.pushState(null,"",t):location.hash=t)})})}function K(){const e=b("#appointmentForm");if(!e)return;const r=b("#appointmentForm-banner"),t=M("#appointmentForm .form__input, #appointmentForm .form__select, #appointmentForm .form__textarea"),s=e.querySelector('button[type="submit"]'),o=new Set(["given-name","family-name","email","phone","service"]);function C(n){n.classList.remove("form__input--error","form__select--error","form__textarea--error")}function v(n){C(n),n.matches("select")?n.classList.add("form__select--error"):n.matches("textarea")?n.classList.add("form__textarea--error"):n.classList.add("form__input--error")}function i(n,c){if(!n||!n.id||!o.has(n.id))return;const p=document.getElementById(`err-${n.id}`);c?(v(n),n.setAttribute("aria-invalid","true"),p&&(p.textContent=c,p.hidden=!1)):(C(n),n.removeAttribute("aria-invalid"),p&&(p.textContent="",p.hidden=!0))}function m(n){const c=n.trim();return c?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(c)?"":"Format d\u2019adresse e-mail invalide.":"Indiquez votre adresse e-mail."}function d(n){const c=String(n).replace(/\D/g,"");return String(n).trim()?c.length<10?"Saisissez au moins 10 chiffres (avec ou sans espaces).":"":"Indiquez un num\xE9ro de t\xE9l\xE9phone."}function l(n){switch(n.id){case"given-name":return n.value.trim()?"":"Indiquez votre pr\xE9nom.";case"family-name":return n.value.trim()?"":"Indiquez votre nom.";case"email":return m(n.value);case"phone":return d(n.value);case"service":return n.value?"":"Choisissez un motif de consultation.";default:return""}}function a(){r&&(r.hidden=!0,r.textContent="")}function f(n){!r||n<1||(r.hidden=!1,r.textContent=n===1?"Veuillez corriger le champ indiqu\xE9 ci-dessous.":`Veuillez corriger les ${n} champs indiqu\xE9s ci-dessous.`)}function u(){o.forEach(n=>{const c=document.getElementById(n);c&&i(c,"")}),a()}function h(){const n=["given-name","family-name","email","phone","service"].map(g=>document.getElementById(g)).filter(Boolean);let c=null,p=0;return n.forEach(g=>{const y=l(g);y?(i(g,y),p+=1,c||(c=g)):i(g,"")}),a(),p>0&&f(p),{ok:p===0,firstInvalid:c}}function x(n){const c=n.target;!c.id||!o.has(c.id)||i(c,l(c))}function A(n){const c=n.target;if(!c.id||!o.has(c.id))return;const p=l(c);i(c,p)}t.forEach(n=>{n.addEventListener("blur",x),n.addEventListener("input",A)}),e.addEventListener("submit",d1),u();const Z=1800,L="https://api.web3forms.com/submit";async function S(n,c){const p=`https://formsubmit.co/ajax/${encodeURIComponent(n)}`,g=await fetch(p,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(c)}),y=await g.text();if(!g.ok)throw new Error(y||g.statusText||"Envoi refus\xE9");return y}async function d1(n){n.preventDefault();const{ok:c,firstInvalid:p}=h();if(!c){p&&(p.focus(),p.scrollIntoView({block:"nearest",behavior:"smooth"})),w.error("Veuillez compl\xE9ter ou corriger les champs indiqu\xE9s dans le formulaire.");return}const g=e.querySelector(".form__hp");if(g&&g.checked){w.error("Impossible d\u2019envoyer le message. R\xE9essayez ou contactez-nous par t\xE9l\xE9phone.");return}const y=b("#given-name").value.trim(),I=b("#family-name").value.trim(),_=b("#email").value.trim(),q=b("#phone").value.trim(),B=b("#service"),m1=B.value,j=B.options[B.selectedIndex],V=j?j.text:m1,P=b("#message").value.trim(),T=`[paro-spe.fr] Demande RDV \u2014 ${V}`,F=["Bonjour,","",`Pr\xE9nom : ${y}`,`Nom : ${I}`,`Email : ${_}`,`T\xE9l\xE9phone : ${q}`,`Motif : ${V}`];P&&F.push("","Message :",P),F.push("","\u2014 Message envoy\xE9 depuis paro-spe.fr");const $=F.join(`
`),D=(e.getAttribute("data-web3forms-access-key")||"").trim(),U=e.getAttribute("data-contact-email")||"secretariat@paro-spe.fr",f1=s.textContent;s.disabled=!0,s.textContent="Envoi en cours\u2026";const W=()=>{w.success("Votre message a bien \xE9t\xE9 envoy\xE9. Nous vous r\xE9pondrons dans les meilleurs d\xE9lais."),e.reset(),u(),typeof gtag<"u"&&gtag("event","form_submit",{event_category:"engagement",event_label:"appointment_form"})},p1=()=>{const E=`mailto:${U}?subject=${encodeURIComponent(T)}&body=${encodeURIComponent($)}`;if(E.length>Z){w.warning("Message trop long pour un lien courriel. Raccourcissez ou \xE9crivez \xE0 secretariat@paro-spe.fr.");return}w.info("Ouverture de votre messagerie avec le message pr\xE9rempli\u2026 Si rien ne s\u2019affiche, \xE9crivez \xE0 secretariat@paro-spe.fr."),e.reset(),u(),window.setTimeout(()=>{window.location.href=E},450)};try{if(D){const E=await fetch(L,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify({access_key:D,subject:T,name:`${y} ${I}`.trim(),email:_,phone:q,message:$,from_name:`${y} ${I}`.trim(),replyto:_,botcheck:!1})});let k;try{k=await E.json()}catch{w.error("R\xE9ponse du service d\u2019envoi invalide. R\xE9essayez dans quelques minutes.");return}if(k&&k.success)W();else{const Y=k&&(k.message||k.body&&k.body.message)||"L\u2019envoi a \xE9chou\xE9. R\xE9essayez plus tard ou contactez-nous par t\xE9l\xE9phone.";w.error(Y)}}else await S(U,{_subject:T,_replyto:_,_captcha:"false",name:`${y} ${I}`.trim(),email:_,phone:q,motif:V,message:$}),W()}catch{D?w.error("Connexion impossible. V\xE9rifiez votre r\xE9seau puis r\xE9essayez."):(w.warning("Envoi automatique indisponible. Nous ouvrons votre messagerie avec le message pr\xE9rempli."),p1())}finally{s.textContent=f1,s.disabled=!1}}}function J(){if(!("IntersectionObserver"in window)){M(".traitement-card, .team-member, .contact__item, .cabinet-media-carousel").forEach(s=>{s.classList.add("reveal","is-visible")});return}const e=new IntersectionObserver(t=>{t.forEach(s=>{if(!s.isIntersecting)return;const o=s.target;o.classList.add("is-visible"),e.unobserve(o)})},{threshold:.1,rootMargin:"0px 0px -50px 0px"});M(".traitement-card, .team-member, .contact__item, .cabinet-media-carousel").forEach(t=>{t.classList.add("reveal"),e.observe(t)})}function Q(){const e=b(".navbar__toggle"),r=b(".navbar__menu--mobile"),t=H(()=>{window.innerWidth>768&&e&&r&&(e.setAttribute("aria-expanded","false"),e.setAttribute("aria-label","Ouvrir le menu"),r.classList.remove("navbar__menu--active"),O())},250);window.addEventListener("resize",t,{passive:!0})}function e1(){M('a[target="_blank"]').forEach(e=>{const r=e.getAttribute("rel")||"";/\bnoopener\b/i.test(r)||e.setAttribute("rel",r?`${r} noopener noreferrer`.trim():"noopener noreferrer")})}function t1(){const e=M("img[data-src]");if(e.length===0)return;if(!("IntersectionObserver"in window)){e.forEach(t=>{t.dataset.src&&(t.src=t.dataset.src)});return}const r=new IntersectionObserver(t=>{t.forEach(s=>{if(s.isIntersecting){const o=s.target;o.dataset.src&&(o.src=o.dataset.src,o.removeAttribute("data-src")),o.classList.remove("lazy"),r.unobserve(o)}})},{rootMargin:"50px",threshold:.01});e.forEach(t=>r.observe(t))}function r1(){function e(r,t,s){typeof gtag<"u"&&gtag("event",t,{event_category:r,event_label:s})}M(".btn--primary").forEach(r=>{r.addEventListener("click",()=>{e("engagement","cta_click",r.textContent.trim())})})}function o1(){const e=new Date().getFullYear();M(".copyright-year").forEach(t=>{t.textContent=e})}function n1(){o1(),(function(){const t="assets/Icones/icons.svg",s="http://www.w3.org/1999/xlink",o="svg-sprite-runtime",C=`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
</svg>`;let v=!1;function i(){return document.querySelector('svg use[href*="assets/Icones/icons.svg#"], svg use[href*="assets/icones/icons.svg#"], svg use[xlink\\:href*="assets/Icones/icons.svg#"], svg use[xlink\\:href*="assets/icones/icons.svg#"]')}function m(){document.querySelectorAll("svg use[href], svg use[xlink\\:href]").forEach(a=>{const f=a.getAttribute("href")||a.getAttribute("xlink:href");if(!f)return;const u=f.match(/(?:^|\/)assets\/[Ii]cones\/icons\.svg#(.+)$/);if(!u)return;const h=`#${u[1]}`;a.setAttribute("href",h),a.setAttributeNS(s,"xlink:href",h)})}async function d(){if(document.getElementById(o)){m();return}let a="";if(location.protocol!=="file:")try{const h=await fetch(t,{cache:"force-cache"});if(!h.ok)throw new Error(`sprite fetch failed (${h.status})`);a=await h.text()}catch{a=C}else a=C;const f=document.createElement("div");f.innerHTML=a.trim();const u=f.querySelector("svg");if(!u)throw new Error("sprite svg missing");u.id=o,u.setAttribute("aria-hidden","true"),u.setAttribute("focusable","false"),u.style.position="absolute",u.style.width="0",u.style.height="0",u.style.overflow="hidden",u.style.pointerEvents="none",u.style.left="-9999px",u.style.top="-9999px",document.body.insertAdjacentElement("afterbegin",u),m()}function l(){v||(v=!0,Promise.resolve().then(()=>d()).catch(()=>{try{document.querySelectorAll("svg use[href]").forEach(a=>{const f=a.getAttribute("href");f&&(a.getAttribute("xlink:href")||a.setAttributeNS(s,"xlink:href",f))})}catch{}}))}if(i()){if(location.protocol==="file:"){l();return}if("IntersectionObserver"in window){const a=i();if(!a)return;const f=new IntersectionObserver(u=>{u.some(h=>h.isIntersecting)&&(f.disconnect(),l())},{rootMargin:"400px 0px"});f.observe(a)}else window.requestIdleCallback?requestIdleCallback(l,{timeout:1500}):setTimeout(l,200)}})();const e=b("#hero-title");e&&e.classList.add("is-visible")}function i1(){X(),G(),K(),Q(),e1()}function R(){N(()=>{J(),t1(),r1()}),N(()=>{const e=b('.sidebar__action[aria-label="Retour en haut"]');e&&e.addEventListener("click",function(r){r.preventDefault();const t=window.scrollY||window.pageYOffset,s=400,o=performance.now(),C=i=>1-Math.pow(1-i,3);function v(i){const m=i-o,d=Math.min(m/s,1),l=C(d);window.scrollTo(0,t*(1-l)),d<1&&requestAnimationFrame(v)}requestAnimationFrame(v)})})}function s1(){n1(),i1(),window.requestIdleCallback?requestIdleCallback(()=>{R()},{timeout:2e3}):setTimeout(()=>{R()},100)}function a1(){const e=b(".hero__video[data-hero-src]");if(!e)return;const r=e.getAttribute("data-hero-src");if(!r)return;try{if(window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches)return}catch{}try{if(navigator.connection&&navigator.connection.saveData)return;if(navigator.connection&&typeof navigator.connection.effectiveType=="string"){const o=navigator.connection.effectiveType;if(o==="slow-2g"||o==="2g")return}}catch{}if(e.querySelector("source"))return;const t=()=>{const o=document.createElement("source");o.src=r,o.type="video/mp4",e.appendChild(o);try{e.load()}catch{}const C=e.play();C&&typeof C.catch=="function"&&C.catch(()=>{})},s=()=>{window.requestIdleCallback?requestIdleCallback(t,{timeout:4e3}):setTimeout(t,900)};document.readyState==="complete"?s():window.addEventListener("load",s,{once:!0})}function c1(){a1()}function l1(){if(!("serviceWorker"in navigator))return;const e=()=>{navigator.serviceWorker.register("sw.js").catch(()=>{})};window.requestIdleCallback?requestIdleCallback(e,{timeout:8e3}):setTimeout(e,2500)}function u1(){const e=document.querySelector("[data-map-consent][data-map-src]");if(!e)return;const r=e.querySelector(".map__activate");if(!r)return;const t=e.getAttribute("data-map-src");if(!t)return;const s=()=>{if(e.getAttribute("data-map-loaded")==="true")return;e.setAttribute("data-map-loaded","true");const o=document.createElement("iframe");o.src=t,o.width="100%",o.height="400",o.className="map__iframe",o.allowFullscreen=!0,o.loading="lazy",o.referrerPolicy="no-referrer-when-downgrade",o.title="Carte : 40 Avenue de la Division Leclerc, 92290 Ch\xE2tenay-Malabry",o.setAttribute("aria-label","Carte Google Maps centr\xE9e sur 40 Avenue de la Division Leclerc, 92290 Ch\xE2tenay-Malabry"),e.replaceWith(o)};r.addEventListener("click",s,{once:!0})}z(c1),z(s1),z(l1),z(u1),(function(){if(document.querySelector('link[rel="manifest"]'))return;function r(){const s=document.createElement("link");s.rel="manifest",s.href="site.webmanifest",document.head.appendChild(s)}function t(){window.requestIdleCallback?requestIdleCallback(r,{timeout:3500}):setTimeout(r,0)}document.readyState==="complete"?t():window.addEventListener("load",t,{once:!0})})()})();
