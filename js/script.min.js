...
(function(){"use strict";const h=e=>document.querySelector(e),L=e=>document.querySelectorAll(e);function H(e,o){let t;return function(...n){clearTimeout(t),t=setTimeout(()=>e(...n),o)}}function N(e){window.requestIdleCallback?requestIdleCallback(e,{timeout:100}):setTimeout(e,1)}function E(e){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}let O=()=>{};const w=(()=>{const o={success:6500,info:5500,error:1e4,warning:8e3},t=[];function s(i){return i==="success"?"i-check-circle":i==="error"?"i-alert-circle":i==="warning"?"i-alert-triangle":"i-info"}function n(){for(;t.length>=4;){const i=t.shift();i.timer&&clearTimeout(i.timer),i.el&&i.el.parentNode&&i.el.remove()}}function v(i){const m=t.findIndex(d=>d.el===i);m>=0&&(t[m].timer&&clearTimeout(t[m].timer),t.splice(m,1)),!(!i||!i.parentNode)&&(i.classList.add("toast--leaving"),window.setTimeout(()=>{i.parentNode&&i.remove()},280))}function b(i,m="info"){if(!i||typeof i!="string")return;n();const d=document.createElement("div");d.className=`toast toast--${m}`,d.setAttribute("role",m==="error"?"alert":"status"),d.setAttribute("aria-live",m==="error"?"assertive":"polite");const l=document.createElement("div");l.className="toast__row";const a=document.createElementNS("http://www.w3.org/2000/svg","svg");a.setAttribute("class","toast__icon icon"),a.setAttribute("aria-hidden","true");const f=document.createElementNS("http://www.w3.org/2000/svg","use");f.setAttribute("href",`#${s(m)}`),a.appendChild(f);const u=document.createElement("p");u.className="toast__text",u.textContent=i;const C=document.createElement("button");C.type="button",C.className="toast__close",C.setAttribute("aria-label","Fermer la notification");const x=document.createElementNS("http://www.w3.org/2000/svg","svg");x.setAttribute("class","icon"),x.setAttribute("aria-hidden","true");const A=document.createElementNS("http://www.w3.org/2000/svg","use");A.setAttribute("href","#i-x"),x.appendChild(A),C.appendChild(x),l.appendChild(a),l.appendChild(u),d.appendChild(l),d.appendChild(C),(document.getElementById("toast-host")||document.body).appendChild(d);const M={el:d,timer:null};t.push(M),window.requestAnimationFrame(()=>d.classList.add("toast--visible"));const S=o[m]||o.info;M.timer=window.setTimeout(()=>v(d),S),C.addEventListener("click",()=>{M.timer&&clearTimeout(M.timer),M.timer=null,v(d)})}return{success:i=>b(i,"success"),error:i=>b(i,"error"),info:i=>b(i,"info"),warning:i=>b(i,"warning")}})();function X(){const e=h(".navbar"),o=h(".navbar__toggle"),t=h(".navbar__menu--mobile");if(o&&t){let n=function(){s&&(document.removeEventListener("keydown",i),document.removeEventListener("click",m,!0),s=!1)},v=function(l){o.setAttribute("aria-expanded",l?"true":"false"),o.setAttribute("aria-label",l?"Fermer le menu":"Ouvrir le menu")},b=function(){v(!1),t.classList.remove("navbar__menu--active"),n()},i=function(l){l.key==="Escape"&&t.classList.contains("navbar__menu--active")&&(l.preventDefault(),b(),o.focus())},m=function(l){t.classList.contains("navbar__menu--active")&&(t.contains(l.target)||o.contains(l.target)||b())},d=function(){s||(s=!0,window.setTimeout(()=>{document.addEventListener("keydown",i),document.addEventListener("click",m,!0)},0))},s=!1;O=n,o.addEventListener("click",()=>{const a=!(o.getAttribute("aria-expanded")==="true");if(v(a),t.classList.toggle("navbar__menu--active",a),a){const f=t.querySelector(".navbar__link");f&&f.focus(),d()}else n(),o.focus()}),t.querySelectorAll("a[href]").forEach(l=>{l.addEventListener("click",()=>{t.classList.contains("navbar__menu--active")&&b()})})}if(e){const s=H(()=>{window.scrollY>100?e.classList.add("navbar--scrolled"):e.classList.remove("navbar--scrolled")},10);window.addEventListener("scroll",s,{passive:!0})}}function G(){L('a[href^="#"]').forEach(e=>{e.addEventListener("click",function(o){o.preventDefault();const t=h(this.getAttribute("href"));if(t){const s=t.offsetTop-70;window.scrollTo({top:s,behavior:"smooth"})}})})}function K(){const e=h("#appointmentForm");if(!e)return;const o=h("#appointmentForm-banner"),t=L("#appointmentForm .form__input, #appointmentForm .form__select, #appointmentForm .form__textarea"),s=e.querySelector('button[type="submit"]'),n=new Set(["given-name","family-name","email","phone","service"]);function v(r){r.classList.remove("form__input--error","form__select--error","form__textarea--error")}function b(r){v(r),r.matches("select")?r.classList.add("form__select--error"):r.matches("textarea")?r.classList.add("form__textarea--error"):r.classList.add("form__input--error")}function i(r,c){if(!r||!r.id||!n.has(r.id))return;const p=document.getElementById(`err-${r.id}`);c?(b(r),r.setAttribute("aria-invalid","true"),p&&(p.textContent=c,p.hidden=!1)):(v(r),r.removeAttribute("aria-invalid"),p&&(p.textContent="",p.hidden=!0))}function m(r){const c=r.trim();return c?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(c)?"":"Format d\u2019adresse e-mail invalide.":"Indiquez votre adresse e-mail."}function d(r){const c=String(r).replace(/\D/g,"");return String(r).trim()?c.length<10?"Saisissez au moins 10 chiffres (avec ou sans espaces).":"":"Indiquez un num\xE9ro de t\xE9l\xE9phone."}function l(r){switch(r.id){case"given-name":return r.value.trim()?"":"Indiquez votre pr\xE9nom.";case"family-name":return r.value.trim()?"":"Indiquez votre nom.";case"email":return m(r.value);case"phone":return d(r.value);case"service":return r.value?"":"Choisissez un motif de consultation.";default:return""}}function a(){o&&(o.hidden=!0,o.textContent="")}function f(r){!o||r<1||(o.hidden=!1,o.textContent=r===1?"Veuillez corriger le champ indiqu\xE9 ci-dessous.":`Veuillez corriger les ${r} champs indiqu\xE9s ci-dessous.`)}function u(){n.forEach(r=>{const c=document.getElementById(r);c&&i(c,"")}),a()}function C(){const r=["given-name","family-name","email","phone","service"].map(g=>document.getElementById(g)).filter(Boolean);let c=null,p=0;return r.forEach(g=>{const y=l(g);y?(i(g,y),p+=1,c||(c=g)):i(g,"")}),a(),p>0&&f(p),{ok:p===0,firstInvalid:c}}function x(r){const c=r.target;!c.id||!n.has(c.id)||i(c,l(c))}function A(r){const c=r.target;if(!c.id||!n.has(c.id))return;const p=l(c);i(c,p)}t.forEach(r=>{r.addEventListener("blur",x),r.addEventListener("input",A)}),e.addEventListener("submit",d1),u();const Z=1800,M="https://api.web3forms.com/submit";async function S(r,c){const p=`https://formsubmit.co/ajax/${encodeURIComponent(r)}`,g=await fetch(p,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(c)}),y=await g.text();if(!g.ok)throw new Error(y||g.statusText||"Envoi refus\xE9");return y}async function d1(r){r.preventDefault();const{ok:c,firstInvalid:p}=C();if(!c){p&&(p.focus(),p.scrollIntoView({block:"nearest",behavior:"smooth"})),w.error("Veuillez compl\xE9ter ou corriger les champs indiqu\xE9s dans le formulaire.");return}const g=e.querySelector(".form__hp");if(g&&g.checked){w.error("Impossible d\u2019envoyer le message. R\xE9essayez ou contactez-nous par t\xE9l\xE9phone.");return}const y=h("#given-name").value.trim(),I=h("#family-name").value.trim(),_=h("#email").value.trim(),q=h("#phone").value.trim(),B=h("#service"),m1=B.value,j=B.options[B.selectedIndex],V=j?j.text:m1,P=h("#message").value.trim(),T=`[parodontia.fr] Demande RDV \u2014 ${V}`,F=["Bonjour,","",`Pr\xE9nom : ${y}`,`Nom : ${I}`,`Email : ${_}`,`T\xE9l\xE9phone : ${q}`,`Motif : ${V}`];P&&F.push("","Message :",P),F.push("","\u2014 Message envoy\xE9 depuis parodontia.fr");const $=F.join(`
`),D=(e.getAttribute("data-web3forms-access-key")||"").trim(),U=e.getAttribute("data-contact-email")||"contact@parodontia.fr",f1=s.textContent;s.disabled=!0,s.textContent="Envoi en cours\u2026";const W=()=>{w.success("Votre message a bien \xE9t\xE9 envoy\xE9. Nous vous r\xE9pondrons dans les meilleurs d\xE9lais."),e.reset(),u(),typeof gtag<"u"&&gtag("event","form_submit",{event_category:"engagement",event_label:"appointment_form"})},p1=()=>{const z=`mailto:${U}?subject=${encodeURIComponent(T)}&body=${encodeURIComponent($)}`;if(z.length>Z){w.warning("Message trop long pour un lien courriel. Raccourcissez ou \xE9crivez \xE0 contact@parodontia.fr.");return}w.info("Ouverture de votre messagerie avec le message pr\xE9rempli\u2026 Si rien ne s\u2019affiche, \xE9crivez \xE0 contact@parodontia.fr."),e.reset(),u(),window.setTimeout(()=>{window.location.href=z},450)};try{if(D){const z=await fetch(M,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify({access_key:D,subject:T,name:`${y} ${I}`.trim(),email:_,phone:q,message:$,from_name:`${y} ${I}`.trim(),replyto:_,botcheck:!1})});let k;try{k=await z.json()}catch{w.error("R\xE9ponse du service d\u2019envoi invalide. R\xE9essayez dans quelques minutes.");return}if(k&&k.success)W();else{const Y=k&&(k.message||k.body&&k.body.message)||"L\u2019envoi a \xE9chou\xE9. R\xE9essayez plus tard ou contactez-nous par t\xE9l\xE9phone.";w.error(Y)}}else await S(U,{_subject:T,_replyto:_,_captcha:"false",name:`${y} ${I}`.trim(),email:_,phone:q,motif:V,message:$}),W()}catch{D?w.error("Connexion impossible. V\xE9rifiez votre r\xE9seau puis r\xE9essayez."):(w.warning("Envoi automatique indisponible. Nous ouvrons votre messagerie avec le message pr\xE9rempli."),p1())}finally{s.textContent=f1,s.disabled=!1}}}function J(){if(!("IntersectionObserver"in window)){L(".traitement-card, .team-member, .contact__item, .cabinet-media-carousel").forEach(s=>{s.classList.add("reveal","is-visible")});return}const e=new IntersectionObserver(t=>{t.forEach(s=>{if(!s.isIntersecting)return;const n=s.target;n.classList.add("is-visible"),e.unobserve(n)})},{threshold:.1,rootMargin:"0px 0px -50px 0px"});L(".traitement-card, .team-member, .contact__item, .cabinet-media-carousel").forEach(t=>{t.classList.add("reveal"),e.observe(t)})}function Q(){const e=h(".navbar__toggle"),o=h(".navbar__menu--mobile"),t=H(()=>{window.innerWidth>768&&e&&o&&(e.setAttribute("aria-expanded","false"),e.setAttribute("aria-label","Ouvrir le menu"),o.classList.remove("navbar__menu--active"),O())},250);window.addEventListener("resize",t,{passive:!0})}function e1(){L('a[target="_blank"]').forEach(e=>{const o=e.getAttribute("rel")||"";/\bnoopener\b/i.test(o)||e.setAttribute("rel",o?`${o} noopener noreferrer`.trim():"noopener noreferrer")})}function t1(){const e=L("img[data-src]");if(e.length===0)return;if(!("IntersectionObserver"in window)){e.forEach(t=>{t.dataset.src&&(t.src=t.dataset.src)});return}const o=new IntersectionObserver(t=>{t.forEach(s=>{if(s.isIntersecting){const n=s.target;n.dataset.src&&(n.src=n.dataset.src,n.removeAttribute("data-src")),n.classList.remove("lazy"),o.unobserve(n)}})},{rootMargin:"50px",threshold:.01});e.forEach(t=>o.observe(t))}function o1(){function e(o,t,s){typeof gtag<"u"&&gtag("event",t,{event_category:o,event_label:s})}L(".btn--primary").forEach(o=>{o.addEventListener("click",()=>{e("engagement","cta_click",o.textContent.trim())})})}function r1(){const e=new Date().getFullYear();L(".copyright-year").forEach(t=>{t.textContent=e})}function n1(){r1(),(function(){const t="assets/Icones/icons.svg",s="http://www.w3.org/1999/xlink",n="svg-sprite-runtime",v=`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
</svg>`;let b=!1;function i(){return document.querySelector('svg use[href*="assets/Icones/icons.svg#"], svg use[href*="assets/icones/icons.svg#"], svg use[xlink\\:href*="assets/Icones/icons.svg#"], svg use[xlink\\:href*="assets/icones/icons.svg#"]')}function m(){document.querySelectorAll("svg use[href], svg use[xlink\\:href]").forEach(a=>{const f=a.getAttribute("href")||a.getAttribute("xlink:href");if(!f)return;const u=f.match(/(?:^|\/)assets\/[Ii]cones\/icons\.svg#(.+)$/);if(!u)return;const C=`#${u[1]}`;a.setAttribute("href",C),a.setAttributeNS(s,"xlink:href",C)})}async function d(){if(document.getElementById(n)){m();return}let a="";if(location.protocol!=="file:")try{const C=await fetch(t,{cache:"force-cache"});if(!C.ok)throw new Error(`sprite fetch failed (${C.status})`);a=await C.text()}catch{a=v}else a=v;const f=document.createElement("div");f.innerHTML=a.trim();const u=f.querySelector("svg");if(!u)throw new Error("sprite svg missing");u.id=n,u.setAttribute("aria-hidden","true"),u.setAttribute("focusable","false"),u.style.position="absolute",u.style.width="0",u.style.height="0",u.style.overflow="hidden",u.style.pointerEvents="none",u.style.left="-9999px",u.style.top="-9999px",document.body.insertAdjacentElement("afterbegin",u),m()}function l(){b||(b=!0,Promise.resolve().then(()=>d()).catch(()=>{try{document.querySelectorAll("svg use[href]").forEach(a=>{const f=a.getAttribute("href");f&&(a.getAttribute("xlink:href")||a.setAttributeNS(s,"xlink:href",f))})}catch{}}))}if(i()){if(location.protocol==="file:"){l();return}if("IntersectionObserver"in window){const a=i();if(!a)return;const f=new IntersectionObserver(u=>{u.some(C=>C.isIntersecting)&&(f.disconnect(),l())},{rootMargin:"400px 0px"});f.observe(a)}else window.requestIdleCallback?requestIdleCallback(l,{timeout:1500}):setTimeout(l,200)}})();const e=h("#hero-title");e&&e.classList.add("is-visible")}function i1(){X(),G(),K(),Q(),e1()}function R(){N(()=>{J(),t1(),o1()}),N(()=>{const e=h('.sidebar__action[aria-label="Retour en haut"]');e&&e.addEventListener("click",function(o){o.preventDefault();const t=window.scrollY||window.pageYOffset,s=400,n=performance.now(),v=i=>1-Math.pow(1-i,3);function b(i){const m=i-n,d=Math.min(m/s,1),l=v(d);window.scrollTo(0,t*(1-l)),d<1&&requestAnimationFrame(b)}requestAnimationFrame(b)})})}function s1(){n1(),i1(),window.requestIdleCallback?requestIdleCallback(()=>{R()},{timeout:2e3}):setTimeout(()=>{R()},100)}function a1(){const e=h(".hero__video[data-hero-src]");if(!e)return;const o=e.getAttribute("data-hero-src");if(!o)return;try{if(window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches)return}catch{}try{if(navigator.connection&&navigator.connection.saveData)return;if(navigator.connection&&typeof navigator.connection.effectiveType=="string"){const n=navigator.connection.effectiveType;if(n==="slow-2g"||n==="2g")return}}catch{}if(e.querySelector("source"))return;const t=()=>{const n=document.createElement("source");n.src=o,n.type="video/mp4",e.appendChild(n);try{e.load()}catch{}const v=e.play();v&&typeof v.catch=="function"&&v.catch(()=>{})},s=()=>{window.requestIdleCallback?requestIdleCallback(t,{timeout:4e3}):setTimeout(t,900)};document.readyState==="complete"?s():window.addEventListener("load",s,{once:!0})}function c1(){a1()}function l1(){if(!("serviceWorker"in navigator))return;const e=()=>{navigator.serviceWorker.register("sw.js").catch(()=>{})};window.requestIdleCallback?requestIdleCallback(e,{timeout:8e3}):setTimeout(e,2500)}function u1(){const e=document.querySelector("[data-map-consent][data-map-src]");if(!e)return;const o=e.querySelector(".map__activate");if(!o)return;const t=e.getAttribute("data-map-src");if(!t)return;const s=()=>{if(e.getAttribute("data-map-loaded")==="true")return;e.setAttribute("data-map-loaded","true");const n=document.createElement("iframe");n.src=t,n.width="100%",n.height="400",n.className="map__iframe",n.allowFullscreen=!0,n.loading="lazy",n.referrerPolicy="no-referrer-when-downgrade",n.title="Carte : 40 Avenue de la Division Leclerc, 92290 Ch\xE2tenay-Malabry",n.setAttribute("aria-label","Carte Google Maps centr\xE9e sur 40 Avenue de la Division Leclerc, 92290 Ch\xE2tenay-Malabry"),e.replaceWith(n)};o.addEventListener("click",s,{once:!0})}E(c1),E(s1),E(l1),E(u1),(function(){if(document.querySelector('link[rel="manifest"]'))return;function o(){const s=document.createElement("link");s.rel="manifest",s.href="site.webmanifest",document.head.appendChild(s)}function t(){window.requestIdleCallback?requestIdleCallback(o,{timeout:3500}):setTimeout(o,0)}document.readyState==="complete"?t():window.addEventListener("load",t,{once:!0})})()})();
